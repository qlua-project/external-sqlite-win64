...
#else
typedef void  (SQLITE_TCLAPI Tcl_ThreadCreateProc) (void *clientData);
#endif
 ...
 * reference in sqlite_tclDecls.h.
 */
...
typedef int  (SQLITE_TCLAPI Tcl_AppInitProc) (Tcl_Interp *interp);
typedef int  (SQLITE_TCLAPI Tcl_AsyncProc) (void *clientData, Tcl_Interp *interp,
	int code);
typedef void  (SQLITE_TCLAPI Tcl_ChannelProc) (void *clientData, int mask);
typedef void  (SQLITE_TCLAPI Tcl_CloseProc) (void *data);
typedef void  (SQLITE_TCLAPI Tcl_CmdDeleteProc) (void *clientData);
typedef int  (SQLITE_TCLAPI Tcl_CmdProc) (void *clientData, Tcl_Interp *interp,
	int argc, const char *argv[]);
typedef void  (SQLITE_TCLAPI Tcl_CmdTraceProc) (void *clientData, Tcl_Interp *interp,
	int level, char *command, Tcl_CmdProc *proc,
	void *cmdClientData, int argc, const char *argv[]);
typedef int  (SQLITE_TCLAPI Tcl_CmdObjTraceProc) (void *clientData, Tcl_Interp *interp,
	int level, const char *command, Tcl_Command commandInfo, int objc,
	struct Tcl_Obj *const *objv);
typedef void  (SQLITE_TCLAPI Tcl_CmdObjTraceDeleteProc) (void *clientData);
typedef void  (SQLITE_TCLAPI Tcl_DupInternalRepProc) (struct Tcl_Obj *srcPtr,
	struct Tcl_Obj *dupPtr);
typedef int  (SQLITE_TCLAPI Tcl_EncodingConvertProc) (void *clientData, const char *src,
	int srcLen, int flags, Tcl_EncodingState *statePtr, char *dst,
	int dstLen, int *srcReadPtr, int *dstWrotePtr, int *dstCharsPtr);
typedef void  (SQLITE_TCLAPI Tcl_EncodingFreeProc) (void *clientData);
typedef int  (SQLITE_TCLAPI Tcl_EventProc) (Tcl_Event *evPtr, int flags);
typedef void  (SQLITE_TCLAPI Tcl_EventCheckProc) (void *clientData, int flags);
typedef int  (SQLITE_TCLAPI Tcl_EventDeleteProc) (Tcl_Event *evPtr, void *clientData);
typedef void  (SQLITE_TCLAPI Tcl_EventSetupProc) (void *clientData, int flags);
typedef void  (SQLITE_TCLAPI Tcl_ExitProc) (void *clientData);
typedef void  (SQLITE_TCLAPI Tcl_FileProc) (void *clientData, int mask);
typedef void  (SQLITE_TCLAPI Tcl_FileFreeProc) (void *clientData);
typedef void  (SQLITE_TCLAPI Tcl_FreeInternalRepProc) (struct Tcl_Obj *objPtr);
typedef void  (SQLITE_TCLAPI Tcl_IdleProc) (void *clientData);
typedef void  (SQLITE_TCLAPI Tcl_InterpDeleteProc) (void *clientData,
	Tcl_Interp *interp);
typedef void  (SQLITE_TCLAPI Tcl_NamespaceDeleteProc) (void *clientData);
typedef int  (SQLITE_TCLAPI Tcl_ObjCmdProc) (void *clientData, Tcl_Interp *interp,
	int objc, struct Tcl_Obj *const *objv);
#if TCL_MAJOR_VERSION > 8
typedef int  (SQLITE_TCLAPI Tcl_ObjCmdProc2) (void *clientData, Tcl_Interp *interp,
	Tcl_Size objc, struct Tcl_Obj *const *objv);
typedef int  (SQLITE_TCLAPI Tcl_CmdObjTraceProc2) (void *clientData, Tcl_Interp *interp,
	Tcl_Size level, const char *command, Tcl_Command commandInfo, Tcl_Size objc,
	struct Tcl_Obj *const *objv);
typedef void  (SQLITE_TCLAPI Tcl_FreeProc) (void *blockPtr);
...
typedef void  (SQLITE_TCLAPI Tcl_FreeProc) (char *blockPtr);
#endif
typedef int  (SQLITE_TCLAPI Tcl_LibraryInitProc) (Tcl_Interp *interp);
typedef int  (SQLITE_TCLAPI Tcl_LibraryUnloadProc) (Tcl_Interp *interp, int flags);
typedef void  (SQLITE_TCLAPI Tcl_PanicProc) (const char *format, ...);
typedef void  (SQLITE_TCLAPI Tcl_TcpAcceptProc) (void *callbackData, Tcl_Channel chan,
	char *address, int port);
typedef void  (SQLITE_TCLAPI Tcl_TimerProc) (void *clientData);
typedef int  (SQLITE_TCLAPI Tcl_SetFromAnyProc) (Tcl_Interp *interp, struct Tcl_Obj *objPtr);
typedef void  (SQLITE_TCLAPI Tcl_UpdateStringProc) (struct Tcl_Obj *objPtr);
typedef char *  (SQLITE_TCLAPI Tcl_VarTraceProc) (void *clientData, Tcl_Interp *interp,
	const char *part1, const char *part2, int flags);
typedef void  (SQLITE_TCLAPI Tcl_CommandTraceProc) (void *clientData, Tcl_Interp *interp,
	const char *oldName, const char *newName, int flags);
typedef void  (SQLITE_TCLAPI Tcl_CreateFileHandlerProc) (int fd, int mask, Tcl_FileProc *proc,
	void *clientData);
typedef void  (SQLITE_TCLAPI Tcl_DeleteFileHandlerProc) (int fd);
typedef void  (SQLITE_TCLAPI Tcl_AlertNotifierProc) (void *clientData);
typedef void  (SQLITE_TCLAPI Tcl_ServiceModeHookProc) (int mode);
typedef void * (SQLITE_TCLAPI Tcl_InitNotifierProc) (void);
typedef void  (SQLITE_TCLAPI Tcl_FinalizeNotifierProc) (void *clientData);
typedef void  (SQLITE_TCLAPI Tcl_MainLoopProc) (void);

/* Abstract List functions */
typedef Tcl_Size  (SQLITE_TCLAPI Tcl_ObjTypeLengthProc) (struct Tcl_Obj *listPtr);
typedef int  (SQLITE_TCLAPI Tcl_ObjTypeIndexProc) (Tcl_Interp *interp, struct Tcl_Obj *listPtr,
	Tcl_Size index, struct Tcl_Obj** elemObj);
typedef int  (SQLITE_TCLAPI Tcl_ObjTypeSliceProc) (Tcl_Interp *interp, struct Tcl_Obj *listPtr,
	Tcl_Size fromIdx, Tcl_Size toIdx, struct Tcl_Obj **newObjPtr);
typedef int  (SQLITE_TCLAPI Tcl_ObjTypeReverseProc) (Tcl_Interp *interp,
	struct Tcl_Obj *listPtr, struct Tcl_Obj **newObjPtr);
typedef int  (SQLITE_TCLAPI Tcl_ObjTypeGetElements) (Tcl_Interp *interp,
...
typedef int  (SQLITE_TCLAPI Tcl_ObjTypeReplaceProc) (Tcl_Interp *interp,
	struct Tcl_Obj *listObj, Tcl_Size first, Tcl_Size numToDelete,
	Tcl_Size numToInsert, struct Tcl_Obj *const insertObjs[]);
typedef int  (SQLITE_TCLAPI Tcl_ObjTypeInOperatorProc) (Tcl_Interp *interp,
...
typedef TCL_HASH_TYPE  (SQLITE_TCLAPI Tcl_HashKeyProc) (Tcl_HashTable *tablePtr, void *keyPtr);
typedef int  (SQLITE_TCLAPI Tcl_CompareHashKeysProc) (void *keyPtr, Tcl_HashEntry *hPtr);
typedef Tcl_HashEntry *  (SQLITE_TCLAPI Tcl_AllocHashEntryProc) (Tcl_HashTable *tablePtr,
	void *keyPtr);
typedef void  (SQLITE_TCLAPI Tcl_FreeHashEntryProc) (Tcl_HashEntry *hPtr);
...
struct Tcl_HashTable {
    ...
    int keyType;		/* Type of keys used in this table. It's
				 ...
				 * key. */
    Tcl_HashEntry *(SQLITE_TCLAPI *findProc) (Tcl_HashTable *tablePtr, const char *key);
    Tcl_HashEntry *(SQLITE_TCLAPI *createProc) (Tcl_HashTable *tablePtr, const char *key,
	    int *newPtr);
...
typedef void  (SQLITE_TCLAPI Tcl_SetTimerProc) (const Tcl_Time *timePtr);
typedef int  (SQLITE_TCLAPI Tcl_WaitForEventProc) (const Tcl_Time *timePtr);

/*
 * TIP #233 (Virtualized Time)
 */

typedef void  (SQLITE_TCLAPI Tcl_GetTimeProc)   (Tcl_Time *timebuf, void *clientData);
typedef void  (SQLITE_TCLAPI Tcl_ScaleTimeProc) (Tcl_Time *timebuf, void *clientData);
...
typedef int	 (SQLITE_TCLAPI Tcl_DriverBlockModeProc) (void *instanceData, int mode);
typedef void Tcl_DriverCloseProc;
typedef int	 (SQLITE_TCLAPI Tcl_DriverClose2Proc) (void *instanceData,
			Tcl_Interp *interp, int flags);
typedef int	 (SQLITE_TCLAPI Tcl_DriverInputProc) (void *instanceData, char *buf,
			int toRead, int *errorCodePtr);
typedef int	 (SQLITE_TCLAPI Tcl_DriverOutputProc) (void *instanceData,
			const char *buf, int toWrite, int *errorCodePtr);
typedef void Tcl_DriverSeekProc;
typedef int	 (SQLITE_TCLAPI Tcl_DriverSetOptionProc) (void *instanceData,
			Tcl_Interp *interp, const char *optionName,
			const char *value);
typedef int	 (SQLITE_TCLAPI Tcl_DriverGetOptionProc) (void *instanceData,
			Tcl_Interp *interp, const char *optionName,
			Tcl_DString *dsPtr);
typedef void	 (SQLITE_TCLAPI Tcl_DriverWatchProc) (void *instanceData, int mask);
typedef int	 (SQLITE_TCLAPI Tcl_DriverGetHandleProc) (void *instanceData,
			int direction, void **handlePtr);
typedef int	 (SQLITE_TCLAPI Tcl_DriverFlushProc) (void *instanceData);
typedef int	 (SQLITE_TCLAPI Tcl_DriverHandlerProc) (void *instanceData,
			int interestMask);
typedef long long  (SQLITE_TCLAPI Tcl_DriverWideSeekProc) (void *instanceData,
			long long offset, int mode, int *errorCodePtr);
/*
 * TIP #218, Channel Thread Actions
 */
typedef void	 (SQLITE_TCLAPI Tcl_DriverThreadActionProc) (void *instanceData,
			int action);
/*
 * TIP #208, File Truncation (etc.)
 */
typedef int	 (SQLITE_TCLAPI Tcl_DriverTruncateProc) (void *instanceData,
			long long length);
...
typedef int  (SQLITE_TCLAPI Tcl_FSStatProc) (Tcl_Obj *pathPtr, Tcl_StatBuf *buf);
typedef int  (SQLITE_TCLAPI Tcl_FSAccessProc) (Tcl_Obj *pathPtr, int mode);
typedef Tcl_Channel  (SQLITE_TCLAPI Tcl_FSOpenFileChannelProc) (Tcl_Interp *interp,
	Tcl_Obj *pathPtr, int mode, int permissions);
typedef int  (SQLITE_TCLAPI Tcl_FSMatchInDirectoryProc) (Tcl_Interp *interp, Tcl_Obj *result,
	Tcl_Obj *pathPtr, const char *pattern, Tcl_GlobTypeData *types);
typedef Tcl_Obj *  (SQLITE_TCLAPI Tcl_FSGetCwdProc) (Tcl_Interp *interp);
typedef int  (SQLITE_TCLAPI Tcl_FSChdirProc) (Tcl_Obj *pathPtr);
typedef int  (SQLITE_TCLAPI Tcl_FSLstatProc) (Tcl_Obj *pathPtr, Tcl_StatBuf *buf);
typedef int  (SQLITE_TCLAPI Tcl_FSCreateDirectoryProc) (Tcl_Obj *pathPtr);
typedef int  (SQLITE_TCLAPI Tcl_FSDeleteFileProc) (Tcl_Obj *pathPtr);
typedef int  (SQLITE_TCLAPI Tcl_FSCopyDirectoryProc) (Tcl_Obj *srcPathPtr,
	Tcl_Obj *destPathPtr, Tcl_Obj **errorPtr);
typedef int  (SQLITE_TCLAPI Tcl_FSCopyFileProc) (Tcl_Obj *srcPathPtr, Tcl_Obj *destPathPtr);
typedef int  (SQLITE_TCLAPI Tcl_FSRemoveDirectoryProc) (Tcl_Obj *pathPtr, int recursive,
	Tcl_Obj **errorPtr);
typedef int  (SQLITE_TCLAPI Tcl_FSRenameFileProc) (Tcl_Obj *srcPathPtr, Tcl_Obj *destPathPtr);
typedef void  (SQLITE_TCLAPI Tcl_FSUnloadFileProc) (Tcl_LoadHandle loadHandle);
typedef Tcl_Obj *  (SQLITE_TCLAPI Tcl_FSListVolumesProc) (void);
/* We have to declare the utime structure here. */
struct utimbuf;
typedef int  (SQLITE_TCLAPI Tcl_FSUtimeProc) (Tcl_Obj *pathPtr, struct utimbuf *tval);
typedef int  (SQLITE_TCLAPI Tcl_FSNormalizePathProc) (Tcl_Interp *interp, Tcl_Obj *pathPtr,
	int nextCheckpoint);
typedef int  (SQLITE_TCLAPI Tcl_FSFileAttrsGetProc) (Tcl_Interp *interp, int index,
	Tcl_Obj *pathPtr, Tcl_Obj **objPtrRef);
typedef const char *const *  (SQLITE_TCLAPI Tcl_FSFileAttrStringsProc) (Tcl_Obj *pathPtr,
	Tcl_Obj **objPtrRef);
typedef int  (SQLITE_TCLAPI Tcl_FSFileAttrsSetProc) (Tcl_Interp *interp, int index,
	Tcl_Obj *pathPtr, Tcl_Obj *objPtr);
typedef Tcl_Obj *  (SQLITE_TCLAPI Tcl_FSLinkProc) (Tcl_Obj *pathPtr, Tcl_Obj *toPtr,
	int linkType);
typedef int  (SQLITE_TCLAPI Tcl_FSLoadFileProc) (Tcl_Interp *interp, Tcl_Obj *pathPtr,
	Tcl_LoadHandle *handlePtr, Tcl_FSUnloadFileProc **unloadProcPtr);
typedef int  (SQLITE_TCLAPI Tcl_FSPathInFilesystemProc) (Tcl_Obj *pathPtr,
	void **clientDataPtr);
typedef Tcl_Obj *  (SQLITE_TCLAPI Tcl_FSFilesystemPathTypeProc) (Tcl_Obj *pathPtr);
typedef Tcl_Obj *  (SQLITE_TCLAPI Tcl_FSFilesystemSeparatorProc) (Tcl_Obj *pathPtr);
#define Tcl_FSFreeInternalRepProc Tcl_FreeProc
typedef void * (SQLITE_TCLAPI Tcl_FSDupInternalRepProc) (void *clientData);
typedef Tcl_Obj *  (SQLITE_TCLAPI Tcl_FSInternalToNormalizedProc) (void *clientData);
typedef void * (SQLITE_TCLAPI Tcl_FSCreateInternalRepProc) (Tcl_Obj *pathPtr);
...
typedef void  (SQLITE_TCLAPI Tcl_LimitHandlerProc) (void *clientData, Tcl_Interp *interp);
#if TCL_MAJOR_VERSION > 8
#define Tcl_LimitHandlerDeleteProc Tcl_FreeProc
#else
typedef void  (SQLITE_TCLAPI Tcl_LimitHandlerDeleteProc) (void *clientData);
#endif
...
typedef int  (SQLITE_TCLAPI Tcl_ArgvFuncProc)(void *clientData, Tcl_Obj *objPtr,
	void *dstPtr);
typedef Tcl_Size  (SQLITE_TCLAPI Tcl_ArgvGenFuncProc)(void *clientData, Tcl_Interp *interp,
...
typedef int  (SQLITE_TCLAPI Tcl_NRPostProc) (void *data[], Tcl_Interp *interp,
				int result);
